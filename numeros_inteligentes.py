...
ser = serial.Serial('COM3', 9600)  # Reemplaza 'COMX' con el puerto COM correcto
time.sleep(2)
...
with mp_hands.Hands(
     ...
     while True:
          ret, frame = cap.read()
          if ret == False:
               break  # Salir del ciclo si no se captura ningún fotograma
          ...
          if cv2.waitKey(1) & 0xFF == 27:
               break  # Salir del ciclo si se presiona la tecla 'Esc'
